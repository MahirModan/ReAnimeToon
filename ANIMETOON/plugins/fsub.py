...
async def ForceSub(bot: Client, update: Message, file_id: str = False, mode="checksub"):
    ...
    try:
        ...
        buttons = [
            [
                InlineKeyboardButton("⚡️𝗦𝗲𝗻𝗱 𝗝𝗼𝗶𝗻 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗧𝗼 [ 𝗕𝗮𝗰𝗸𝘂𝗽 ]⚡️", url='https://t.me/+QEOYNVZFiyNmMWE0')
            ],
            [
                InlineKeyboardButton("⚡️𝗦𝗲𝗻𝗱 𝗝𝗼𝗶𝗻 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗧𝗼 𝗖𝗜𝗡𝗘𝗠𝗔𝗥𝗢𝗢𝗠⚡️", url='https://t.me/+IGTISOOheeI3MTdh')
            ],
            [
